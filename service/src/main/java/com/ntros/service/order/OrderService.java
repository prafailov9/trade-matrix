...
public interface OrderService {
    ...
    CompletableFuture<List<Order>> findMatchingBuyOrders(MarketProduct marketProduct, BigDecimal price);

    CompletableFuture<List<Order>> findMatchingSellOrders(MarketProduct marketProduct, BigDecimal price);
}
