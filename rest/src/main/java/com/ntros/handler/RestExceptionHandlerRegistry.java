...
final public class RestExceptionHandlerRegistry {
    ...
    static {
        HANDLERS = Set.of(GenericExceptionHandler.of(WalletCreateFailedException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
                ...
                GenericExceptionHandler.of(MarketPriceNotFoundException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
                ...
                GenericExceptionHandler.of(OrderStatusNotFoundException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
                GenericExceptionHandler.of(OrderStatusUpdateFailedException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
                GenericExceptionHandler.of(OrderTypeNotFoundException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
                GenericExceptionHandler.of(OrderNotFoundException.class, HttpStatus.INTERNAL_SERVER_ERROR, Throwable::getMessage),
